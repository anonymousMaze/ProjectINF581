...
if __name__ == "__main__":
    if ((len(sys.argv) <4) or ((int(sys.argv[1]) != 10) and (int(sys.argv[1]) != 20))):
        ...
        print("python influence_epsilon2.py size_maze ALGO seed\n")
        print("where     size_maze is either 10 or 20")
        print("          ALGO denotes the RL algorithm used, either \"SARSA\" or \"Q\" for Q-LEANRNING")
    ...
    ALGO = sys.argv[2] # either SARSA or Q-LEARNING
    SEED = int(sys.argv[3])
    ...
    if (ALGO == "SARSA"):
        ...
        sr1 = asarray(sr_1)
        save('Simulations/sizeTen/Q/success_rate/sr1.npy', sr1)
        sr2 = asarray(sr_2)
        save('Simulations/sizeTen/Q/success_rate/sr2.npy', sr2)
        sr3 = asarray(sr_3)
        save('Simulations/sizeTen/Q/success_rate/sr3.npy', sr3)
        sr4 = asarray(sr_4)
        save('Simulations/sizeTen/Q/success_rate/sr4.npy', sr4)
        sr5 = asarray(sr_5)
        save('Simulations/sizeTen/Q/success_rate/sr5.npy', sr5)
        sr6 = asarray(sr_6)
        save('Simulations/sizeTen/Q/success_rate/sr6.npy', sr6)
        ...
        resolution_time1 = asarray(resolution_time_1)
        save('Simulations/sizeTen/Q/resolution_time/rt1.npy', resolution_time1)
        resolution_time2 = asarray(resolution_time_2)
        save('Simulations/sizeTen/Q/resolution_time/rt2.npy', resolution_time2)
        resolution_time3 = asarray(resolution_time_3)
        save('Simulations/sizeTen/Q/resolution_time/rt3.npy', resolution_time3)
        resolution_time4 = asarray(resolution_time_4)
        save('Simulations/sizeTen/Q/resolution_time/rt4.npy', resolution_time4)
        resolution_time5 = asarray(resolution_time_5)
        save('Simulations/sizeTen/Q/resolution_time/rt5.npy', resolution_time5)
        resolution_time6 = asarray(resolution_time_6)
        save('Simulations/sizeTen/Q/resolution_time/rt6.npy', resolution_time6)
